...
from excut.explanations_mining.descriptions import Description, is_var
from excut.kg.kg_query_interface import KGQueryInterface, EndPointKGQueryInterface
    ...
    def mine_with_constants(self, head: tuple, max_length=2, min_coverage=-1.0, negative_heads=None):
        ...
        for i in range(1, max_length + 2):
            ...
            for pp in previous_level_descriptions:
                ...
                # bind descriptions from excut.kg
