from ampligraph.latent_features.models.EmbeddingModel import  register_model
...
from excut.embedding.ampligraph_extend.EmbeddingModelContinue import EmbeddingModelContinue


@register_model("DistMult",
                ["normalize_ent_emb", "negative_corruption_entities"])
class DistMult(EmbeddingModelContinue):
    ...
    def fit(self, X, early_stopping=False, early_stopping_params={}, continue_training=False):
        ...
        """
        super().fit(X, early_stopping, early_stopping_params,continue_training)
