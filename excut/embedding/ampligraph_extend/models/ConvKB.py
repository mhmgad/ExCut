...
from ampligraph.latent_features.models.EmbeddingModel import register_model, ENTITY_THRESHOLD
from ..EmbeddingModelContinue import EmbeddingModelContinue
...
class ConvKB(EmbeddingModelContinue):
