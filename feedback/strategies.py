...
from feedback.rulebased_deduction.deduction_engine import SparqlBasedDeductionEngine
...
from kg.kg_triples_source import SimpleTriplesSource
from clustering.target_entities import EntityLabels
