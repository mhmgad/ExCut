...
from explanations_mining.explaining_engines import ClustersExplainer
...
from kg.kg_query_interface_extended import KGQueryInterfaceExtended
...
class PathBasedClustersExplainerExtended(ClustersExplainer):
    ...
    def __init__(self, kg_query_interface: KGQueryInterfaceExtended, labels_indexer=None, relation=DEFUALT_AUX_RELATION,
                 ...
                 language_bias=None):
        super().__init__()
        self.language_bias = language_bias if language_bias else {'max_length': 2, 'structure': ExplanationStructure.SUBGRAPH}
